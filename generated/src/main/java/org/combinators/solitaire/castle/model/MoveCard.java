...
public class MoveCard extends Move {
    ...
    public boolean valid(Solitaire game) {
        return (true && ConstraintHelper.ifCompute(destination.empty(), () -> movingCard != null, () -> (destination.peek().getRank() == (movingCard.getRank() % 13) + 1 && movingCard.getSuit() == destination.peek().getSuit())));
    }
}
