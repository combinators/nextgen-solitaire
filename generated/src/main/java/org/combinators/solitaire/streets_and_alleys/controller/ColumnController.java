package org.combinators.solitaire.streets_and_alleys.controller;

import org.combinators.solitaire.streets_and_alleys.*;
...
public class ColumnController extends SolitaireReleasedAdapter {
    ...
    protected Streets_And_Alleys theGame;
    ...
    public ColumnController(Streets_And_Alleys theGame, ColumnView src) {
        super(theGame);
